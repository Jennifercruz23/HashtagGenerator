// src/lib.rs
/*
 * Core library for HashtagGenerator
 */
...
#[derive(Debug)]
pub struct HashtagGeneratorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HashtagGeneratorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HashtagGenerator processing");
    
    let mut processor = HashtagGeneratorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HashtagGeneratorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HashtagGeneratorProcessor::new(false);
